...
7. [ ] After a repo's X2 delivered → F1 (domio #1537, athportal #2008, swarm-os #114). **Gate satisfied — F1 ready to deliver:** `blocked_by` X2 (done) + MP-9 #10 (done, runbook templates shipped via mp #42); all three F1 stories are OPEN / `agent::ready`.
